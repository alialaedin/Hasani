...
use App\Classes\Core\Classes\CoreSettings;
use App\Classes\Sms\Exceptions\ApiException;
use App\Classes\Sms\Exceptions\BaseRuntimeException;
use App\Classes\Sms\Exceptions\HttpException;
use App\Classes\Sms\SmsInterface;
...
class Kavenegar implements SmsInterface
{
    ...
    public string $drive = 'kavehnegar';
